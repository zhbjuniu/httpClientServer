...
<pkg:package
	...
	<pkg:part pkg:name="/docProps/app.xml"
		...
		<pkg:xmlData>
			...
			<Application>WPS
			Office_10.1.0.6877_F1E327BC-269C-435d-A152-05C5408002CA</Application>
	...
	<pkg:part pkg:name="/docProps/core.xml"
		...
		<pkg:xmlData>
			<cp:coreProperties
				...
				<dcterms:created xsi:type="dcterms:W3CDTF">2017-11-26T11:37:00Z</dcterms:created>
				<dc:creator>zhb091023</dc:creator>
				<cp:lastModifiedBy>zhb091023</cp:lastModifiedBy>
				<dcterms:modified xsi:type="dcterms:W3CDTF">2017-11-26T11:58:51Z</dcterms:modified>
	...
	<pkg:part pkg:name="/docProps/custom.xml"
		...
		<pkg:xmlData>
			...
			<vt:lpwstr>2052-10.1.0.6877</vt:lpwstr></property></Properties>
		</pkg:xmlData>
	</pkg:part>
	...
	<pkg:part pkg:name="/word/settings.xml"
		...
		<pkg:xmlData>
			<w:settings
				...
				<w:rsids>
					<w:rsidRoot w:val="690712C9" />
					<w:rsid w:val="29697541" />
					<w:rsid w:val="2C3379D4" />
					<w:rsid w:val="67BD1FA8" />
					<w:rsid w:val="690712C9" />
					<w:rsid w:val="697E4855" />
				</w:rsids>
				<m:mathPr>
		...
		<pkg:xmlData>
			<w:styles
				...
				<w:latentStyles w:count="260" w:defQFormat="0"
					...
					<w:lsdException w:qFormat="1" w:unhideWhenUsed="0" w:uiPriority="0"
						w:semiHidden="0" w:name="Subtitle" />
					<w:lsdException w:unhideWhenUsed="0" w:uiPriority="0"
					...
					<w:lsdException w:qFormat="1" w:unhideWhenUsed="0" w:uiPriority="0"
						w:semiHidden="0" w:name="Strong" />
					<w:lsdException w:qFormat="1" w:unhideWhenUsed="0" w:uiPriority="0"
						w:semiHidden="0" w:name="Emphasis" />
					<w:lsdException w:unhideWhenUsed="0" w:uiPriority="0"
